...
class varAanmaken(unittest.TestCase):
    ...
    def testAnswer2(self):
        self.assertEqual(helper.answers[1], "conditionVariable1")

    def testAnswer3(self):
        self.assertRegex(helper.answers[2], helper.re.expressionToRegex("conditionVariable1 < 10"))
    ...
    def testAnswer8(self):
        self.assertEqual(helper.answers[7], "8")

    def testAnswer9(self):
        self.assertRegex(helper.answers[8], helper.re.argsRegex("conditionVariable4", "array"))

    def testAnswer10(self):
        self.assertRegex(helper.answers[9], helper.re.expressionToRegex("conditionVariable4 < len\(array\)"))

    def testAnser11(self):
        self.assertEqual(helper.answers[10], "4")
