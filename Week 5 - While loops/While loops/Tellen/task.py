...
#Keyword: while
#Conditie variabele(n): conditionVariable3
...
#Keyword: while
#Conditie variabele(n): conditionVariable4, array
#Conditie: conditionVariable4 < len(array)
#Aantal keer uitgevoerd: 4
while(conditionVariable4 < len(array)):
    print("var4: " + str(conditionVariable4 + 1))
