...
class varAanmaken(unittest.TestCase):
    def testAnswer1(self):
        self.assertEqual(helper.answers[0], "add1Tox")

    def testAnswer2(self):
        self.assertEqual(helper.answers[1], "21")

    def testAnswer3(self):
        self.assertEqual(helper.answers[2], "add1Tox")

    def testAnswer4(self):
        self.assertEqual(helper.answers[3], "25")
